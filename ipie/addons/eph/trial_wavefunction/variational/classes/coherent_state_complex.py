...
from ipie.addons.eph.trial_wavefunction.variational.classes.variational_complex import VariationalComplex
...
class CoherentStateVariational(VariationalComplex):
    ...
    def objective_function(self, x) -> float:
        """"""
        #shift_real, shift_complex, c0a_real, c0a_complex, c0b_real, c0b_complex = self.unpack_x(x)
