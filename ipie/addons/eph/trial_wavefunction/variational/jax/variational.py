...
#        np.save('/n/home01/mbaumgarten/Software/ipie/examples/19-1d_holstein/variational_test/dd1_testing/gnumeric.npy', grad)
#        exit()
...
#        gjax = np.array(jax.grad(self.objective_function)(x), dtype=np.float64)
 ...
 #       np.save('/n/home01/mbaumgarten/Software/ipie/examples/14-1d_holstein/variational_test/dd1_testing/gnumeric.npy', gjax)
 #       exit()        
