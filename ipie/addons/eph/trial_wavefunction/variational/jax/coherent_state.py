...
import plum
from ipie.addons.eph.trial_wavefunction.variational.jax.toyozawa import ToyozawaVariational
from ipie.addons.eph.trial_wavefunction.variational.coherent_state import CoherentStateVariational as d2
...
class CoherentStateVariational(ToyozawaVariational):
    def __init__(
        ...
        self.analytical = d2(shift_init, electron_init, hamiltonian, system, K, cplx)
