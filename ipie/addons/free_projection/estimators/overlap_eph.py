...
class OverlapFP(EstimatorBase):
    def __init__(
        ...
        self._data = {"OvTotal": 0.0j, "Sign": 0.0j}
    ...
    def compute_estimator(
        ...
        self._data["OvTotal"] = xp.sum(walkers.weight * walkers.phase * walkers.ovlp) / walkers.nwalkers
...
class OverlapFPImportance(EstimatorBase):
    def __init__(
        self,
        system=None,
        ham=None,
    ...
    def compute_estimator(
        ...
        self._data["OvTotal"] = xp.sum((walkers.weight + 1j * walkers.phase) * walkers.ovlp) / walkers.nwalkers
        self._data["Sign"] = xp.mean(xp.sign(walkers.ovlp.real))
        return self.data
