...
"""Run a four-site Holstein model through the ab-initio EPh AFQMC path."""
...
def parse_args():
    ...
    parser.add_argument("--stabilize-freq", type=int, default=10)
    parser.add_argument("--pop-control-freq", type=int, default=10)
...
def main():
    ...
    try:
        ...
        if comm.rank == 0:
            print("# Four-site Holstein via ab-initio EPh tensors.")
            print(f"# nsites = {args.nsites}")
            print(f"# t = {args.t}")
            print(f"# g = {args.g}; stored g_qnu_kmn = g / sqrt(N)")
            print(f"# w0 = {args.w0}")
