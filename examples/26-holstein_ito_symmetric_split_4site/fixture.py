...
def build_workflow(
    ...
    mean_field_subtraction: bool = True,
    ...
    split_gauge_q_optimize: bool = False,
    split_gauge_q_per_walker: bool = False,
    split_gauge_q_stride: int = None,
    split_gauge_q_bounds: tuple = None,
    split_gauge_q_smoothing: float = 1.0,
    split_gauge_electron_cost: str = "auto",
    ...
    if importance_sampling:
        propagator = ItoSymmSplitImportancePropagatorFP(
            ...
            split_gauge_q_optimize=split_gauge_q_optimize,
            split_gauge_q_per_walker=split_gauge_q_per_walker,
            split_gauge_q_stride=split_gauge_q_stride,
            split_gauge_q_bounds=split_gauge_q_bounds,
            split_gauge_q_smoothing=split_gauge_q_smoothing,
            split_gauge_electron_cost=split_gauge_electron_cost,
