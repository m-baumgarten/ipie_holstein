...
"""Four-site Holstein model using the bare Ito coherent-state propagator."""
...
def build_holstein_ito_inputs(
    ...
    """Build a deterministic Toyozawa/coherent-state walker input."""
    nelec = (1, 0)
...
def build_workflow(inputs: HolsteinItoInputs, timestep: float = 0.005):
    """Construct the Ito coherent-state walker pipeline for the Holstein model."""
    ...
    propagator = EulerItoPropagator(time_step=timestep)
